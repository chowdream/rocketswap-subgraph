...
export class Swap extends Entity {
  ...
  get amount0(): BigInt {
    ...
    return value !== null ? value.toBigInt() : BigInt.fromI32(0);
  }
...
export class SwapEvent {
  ...
  transaction: SwapEventTransaction;
  block: SwapEventBlock;
}

export class SwapEventParams {
  token0: Bytes;
  token1: Bytes;
  amount0: BigInt;
  amount1: BigInt;
...
export class SwapEventTransaction {
  hash: Bytes;
}

export class SwapEventBlock {
  number: BigInt;
}
